...
public class PersistenceStrategyStream<E> implements PersistenceStrategy<E> {
    ...
    public List<E> load() throws PersistenceException {
        ...
        try {
            ...
            throw new PersistenceException(PersistenceException.ExceptionType.ClassError, e.getMessage());
        }
        ...
        throw new PersistenceException(PersistenceException.ExceptionType.ClassError, "Read Object is not of the List-Type!");
    }
}
