...
public class MyPrettyRectangleTest {
    ...
    public void testContains() {
        ...
        assertTrue(right.contains(middle));         //liegt mittig im Rechteck
        assertTrue(right.contains(right));          //enthält sich selber
        assertTrue(left.contains(middle));          //teilt sich einen Teil des Randes
        assertFalse(left.contains(right));          //liegt nur teils darin
        assertFalse(middle.contains(somewhere));    //liegt nicht darin
    }
    ...
    public void testGetCenter() {
        ...
        assertEquals(new MyPoint(2.5, 2), right.getCenter());
    ...
    public void testGetArea() {
        ...
        assertEquals(6, left.getArea(), 1E-4);
        assertEquals(12, right.getArea(), 1E-4);
        assertEquals(1, middle.getArea(), 1E-4);
        assertEquals(3, somewhere.getArea(), 1E-4);
    }
    ...
    public void testGetPerimeter() {
        ...
        assertEquals(10, left.getPerimeter(), 1E-4);
        assertEquals(4, middle.getPerimeter(), 1E-4);
        assertEquals(14, right.getPerimeter(), 1E-4);
        assertEquals(8, somewhere.getPerimeter(), 1E-4);
    }
    ...
    public void testSameIdentity() {
        ...
        assertNotEquals(right, somewhere);
    ...
    public void testGetBoundingBox() {
        ...
        assertFalse(boundingBox.contains(left));
